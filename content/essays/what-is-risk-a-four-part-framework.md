...
![](https://cdn-images-1.medium.com/max/800/1*qLr7JmBXufvD6MOv8tHNPg@2x.jpeg)
...
![](https://cdn-images-1.medium.com/max/800/1*dBtWAf3dFNQrhSHjycm4CQ.png)
...
- [What Happened at Camp Mystic? A Primer on the July 4, 2025 Texas Flood Tragedy](https://medium.com/the-balanced-sheet/what-happened-at-camp-mystic-8f61de2d0f27)

- [Flash Flood Alley: Why Flash Floods Kill Texas Hill Country and the Limits of Early Warning](https://medium.com/the-balanced-sheet/flash-flood-alley-why-flash-floods-kill-a02b7de5d60a)
...
- [Dirt Is Better Than Air](https://medium.com/the-balanced-sheet/dirt-is-better-than-air-08e1e54d4d5c)
...
![](https://cdn-images-1.medium.com/max/800/1*7nzd7Ev-FS6vNEal7MUlXA.png)
...
![](https://cdn-images-1.medium.com/max/800/1*bvWeZs3VCp-VvVhLm4P5xA.png)
...
![](https://cdn-images-1.medium.com/max/800/1*LYhnADVUlLtIh8IZYivjTg.png)
...
![](https://cdn-images-1.medium.com/max/800/1*7SbBzxC95uhh22BO_H1sqg.png)
...
[**Woodwell Climate**](https://www.woodwellclimate.org/drought-panama-canal-7-graphics/)
**and the** [**UN trade and development group**](https://unctad.org/news/suez-and-panama-canal-disruptions-threaten-global-trade-and-development) **have each done interesting analyses on disruptions
to major shipping lane.**

![](https://cdn-images-1.medium.com/max/800/1*wZa-90Hb76clLr4iS1NgZQ.png)
...
1.  **Where are the weak points** in the levee
    walls?
2.  **How much water** is loaded up against the levee
    **when it breaches?**
3.  **What (and who) is behind the levee?** ~ This will
    be known to some degree.
4.  **Detection and closure time** ~ how quickly can
    crews spot, staff, and close a breach?

#### For the Panama Canal Authority:

1.  **When seasonal rains arrive** ~ how much ends up
    **in Gatún/Alhajuela?**
2.  **How strong and how long** the next *El Niño/La
    Niña* cycle runs.
3.  **Net inflows vs. outflows** ~ watershed runoff,
    evaporation, and operational use.
4.  **Will** **new storage** [(Indio River dam)](https://www.npr.org/2025/02/24/g-s1-49456/water-panama-canal-shortage-dam) **move
    forward?** What timeline? Will there be social contraints?
5.  **How quickly will backlogs unwind** once water
    levels and canal operations return to normal?

![](https://cdn-images-1.medium.com/max/800/1*B3oRBCqVUDFdUKeqs1ri7w.png)

*Key uncertainties for our three risk examples.*

### Uncertainties exist in everything.

[The universe itself is governed by immutable rules of probability and chance.](https://physics.stackexchange.com/questions/560067/what-is-the-reason-that-quantum-mechanics-is-random)
...
[especially open systems like the weather.](https://www.science.org/doi/10.1126/science.263.5147.641)
...
2.  **Trace the pathway** so you can block or narrow
    routes.
3.  **Estimate the consequence** so people and property
    stay in view.
4.  **Describe the uncertainty** so choices stay
    disciplined even when the picture is blurry.
