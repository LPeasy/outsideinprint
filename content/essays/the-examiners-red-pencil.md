...
That process has always depended on judgment. The Federal Reserve's [commercial bank examination manual](https://www.federalreserve.gov/supervisionreg/files/cbem.pdf) describes a system built around bank condition, management quality, capital, liquidity, earnings, sensitivity to market risk, and asset quality. The rating system is a common language. The examination letter is the working surface.
...
Bowman's case is straightforward. In a [May speech](https://www.federalreserve.gov/newsevents/speech/bowman20260514a.htm), she argued for transparency, materiality, faster remediation, and supervision that avoids substituting examiner preference for bank management. A bank should know the standard it is expected to meet. A regulator should explain the risk it is trying to reduce. A finding should end when the deficiency is fixed.
