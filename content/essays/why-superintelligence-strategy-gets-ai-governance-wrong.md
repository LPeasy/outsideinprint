...
featured_image: "/images/medium/why-superintelligence-strategy-gets-ai-governance-wrong/592a776fa55614bb3243e96906209f473062b1a05f10601d963ac0b4face73a7.jpeg"
...
The paper, written by Dan Hendrycks, Eric Schmidt, and Alexandr Wang, treats sabotage, chip restrictions, and military superiority as tools for preventing destabilizing breakthroughs.

### Why Sabotage Won't Stop Superintelligence
...
Private companies - Open AI, Google DeepMind, Anthropic, Meta - are leading the charge.
...
Unlike the fragmented, market-driven approach of the U.S., China has clearer strategic AI goals and a stronger state apparatus for enforcing adoption at scale.
...
- Superintelligence would not be just another strategic asset. It could produce a major power shift.
- The authors frame AI as an escalating arms race, but superintelligence could move too quickly for ordinary escalation management.
- Unlike nuclear weapons, which require continuous geopolitical balancing, a self-improving system could leave competitors with little time to respond.
...
Once a nation or company crosses the threshold, there may be little room for "second place": only the entity that controls the system and everyone else.
...
### AI Nonproliferation Is Difficult to Enforce
...
This sounds good in theory. In practice, it's impossible to enforce. Information security will fail.

AI research is decentralized. Leaks are inevitable.

Just as military secrets, nuclear blueprints, and cyberweapons have repeatedly been leaked or stolen, the first truly dangerous AI model weights could end up online.
...
A sufficiently capable system might evade or override pre-programmed ethical constraints.

Open-source AI makes nonproliferation harder.
...
Governments have never been able to contain the spread of powerful knowledge. Once a technology reaches a certain level of openness, control becomes much harder to recover.
...
This assumes a level of trust and restraint that rarely exists in great-power competition. The AI arms race is already underway. The U.S. and China are not negotiating AI restrictions - they are escalating their investments.
...
None of these is guaranteed. AI is not a containable technology like nuclear weapons. Geopolitical competition will always override cooperation.
...
The first truly powerful AI could emerge before any stability framework is fully in place.

### Why Containing AI Will Be Difficult

AI proliferation is moving faster than governments can regulate it.

The first state or private actor to develop superintelligence could set the course of history.
