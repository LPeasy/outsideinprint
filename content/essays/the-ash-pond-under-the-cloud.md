...
subtitle: "EPA's coal-water proposal turns AI's hunger for electricity into a fight over wastewater, grid reliability, and who lives downstream."
description: "EPA's coal-plant wastewater proposal connects AI power demand to coal ash, grid reliability, clean-water rules, and downstream risk."
date: 2026-05-15
draft: false
...
On May 14, 2026, the Environmental Protection Agency put that waste stream back inside the argument over artificial intelligence. The agency [proposed revising wastewater limits](https://www.epa.gov/newsreleases/epa-reinforces-commitment-supporting-reliable-affordable-coal-fired-electricity) for steam electric power plants, saying the change could reduce electricity generation costs by as much as $1.1 billion per year while supporting grid reliability. The [Associated Press reported](https://apnews.com/article/5889bbddc821275731eabb6687ba9e6e) that the proposal would relax limits aimed at keeping toxic heavy metals out of streams and rivers through polluted groundwater.
...
The International Energy Agency says [U.S. electricity consumption is set to rise](https://www.iea.org/reports/electricity-2026/demand) close to 2 percent per year on average, more than twice the pace of the past decade, with data-center expansion as a major driver. In a separate report on [energy demand linked to AI](https://www.iea.org/reports/energy-and-ai/energy-demand-from-ai), the agency projects fast growth in electricity use by accelerated servers. The U.S. Energy Information Administration has also examined a high-demand scenario in which [fossil generation rises](https://www.eia.gov/todayinenergy/detail.php?id=67344) if data-center power demand grows faster than expected.
