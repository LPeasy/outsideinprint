...
Franklin built the lightning rod ~ a simple metal spike and wire that gave lightning a safer path to earth. Churches, homes, and warehouses gained a practical defense against fire from above. The [Franklin Institute's account](https://fi.edu/en/science-and-education/benjamin-franklin/kite-key-experiment) is careful about the myth: Franklin did not discover electricity, and the kite was not struck by lightning. The point was stranger. The storm's charge could be drawn, stored, and studied.
...
The [Whipple Museum at Cambridge](https://www.whipplemuseum.cam.ac.uk/explore-whipple-collections/frogs/frogs-and-animal-electricity) puts the dispute plainly: Galvani saw animal electricity; Volta saw metal contact and moist conductors. Volta's answer became the pile. The [Volta heritage project](https://alessandrovolta.it/en/tool/the-column-battery/) describes it as a device capable of producing electricity continuously, without needing to be recharged.
...
The [IEEE Engineering and Technology History Wiki](https://ethw.org/Milestones%3APearl_Street_Station%2C_1882) records the scale with useful modesty. On September 4, 1882, the station at 257 Pearl Street began supplying electricity to customers in a quarter-square-mile district of Manhattan. It was historic, but small. The first day served fewer than 90 customers.
