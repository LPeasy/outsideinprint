...
description: "A source-free reflection fixture."
image_exempt: true
image_exempt_reason: "Musings may publish without a visual."
version: "1.0"
edition: "First web edition"
featured: false
---
...
description: "A musing fixture that has not cleared the source-free declaration."
image_exempt: true
image_exempt_reason: "Musings may publish without a visual."
version: "1.0"
edition: "First web edition"
...
'@ | Set-Content -Path (Join-Path $musingRoot "unqualified-musing.md") -Encoding UTF8
  ...
  $sourceFreeMusingOutput = & $pwsh -NoProfile -ExecutionPolicy Bypass -File $guardrailScript -Root $tempRoot -Paths "content/essays/musings/source-free-musing.md" -RequireDescription -RequireFeaturedImage -RequireEditorialPhilosophyAudit 2>&1 | Out-String
  $sourceFreeMusingExit = $LASTEXITCODE
