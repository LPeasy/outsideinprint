...
"@
  ...
  $argCommand = '{0} -u "{1}"' -f $PythonCommand, $serverScriptPath
  $proc = Start-Process -FilePath $cmd -ArgumentList @('/c', $argCommand) -PassThru -WindowStyle Hidden -RedirectStandardOutput $outPath -RedirectStandardError $errPath
